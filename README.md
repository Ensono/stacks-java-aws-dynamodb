...
for the [AWS DynamoDB](https://aws.amazon.com/dynamodb/). Simply extending the 
`StacksDynamoDbRepository` class gives you access to the DynamoDB CRUD operations.
...
### Project structure
    ...
    : \_main
    :   \_java
    :    \_com.amido.stacks.dynamodb
    :     \_repository
    :      |_StacksDynamoDbRepository.java
...
2.  Then run
    ...
    mvn archetype:generate \
        ...
        -DarchetypeArtifactId='stacks-aws-dynamodb-archetype' \
...
> **If you previously had used this module under different namespace (i.e. the default `com.amido.stacks.dynamodb`):**
>
...
5.  To create the project, use the command below:
    ...
    <path-to-mvn-executable>/mvnw archetype:generate \
        ...
        -DarchetypeArtifactId='stacks-aws-dynamodb' \
